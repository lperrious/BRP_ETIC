...
public class InscriptionSerialisation extends Serialisation {
    ...
    public void serialiser(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        {   
            //container.addProperty("textToDisplay", "Inscription effectuée");
        } else {
            /*System.out.println((String)request.getAttribute("errorDetail"));
            container.addProperty("errorDetail", (String)request.getAttribute("errorDetail"));*/
        }
